...
const BlogEntry = props => {
  const additionalStyles = props.featured ? `${styles.featuredEntry}` : ""
  const allStyles = `${styles.blogEntry} ${additionalStyles}`
  return (
    <div className={allStyles}>
      ...
      <div>
        ...
        <p className={styles.blogDate}>{props.blogDate}</p>
        <p>
